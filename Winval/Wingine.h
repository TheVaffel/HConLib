...
VkResult Wingine::init_instance( Winval* win){
...
VkResult Wingine::init_surface( Winval* win){
...
void Wingine::init_vertex_buffer(){

  WingineBuffer buf = createBuffer(VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, sizeof(g_vb_solid_face_colors_Data));
  setBuffer(buf, g_vb_solid_face_colors_Data, sizeof(g_vb_solid_face_colors_Data));
...
void Wingine::destroy_vertex_buffer(){
